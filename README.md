...
2.Logistic Regression was used as a baseline model, achieving approximately 77% accuracy and 0.77 ROC-AUC, providing a strong and interpretable starting point.
